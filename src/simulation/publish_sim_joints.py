...
class SimConverter:
    def __init__(self):
        ...
        self.sub_platform_state = rospy.Subscriber('/servo_setpoint/positions', ServoAngles6DoFStamped, self.pos_callback, tcp_nodelay=True) #target pose subscriber
        ...
        self.sub_platform_vel = rospy.Subscriber('/servo_setpoint/velocities', ServoAngles6DoFStamped, self.vel_callback, tcp_nodelay=True) #target pose subscriber
