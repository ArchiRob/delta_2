#ifndef _ROS_delta_manipulator_servo_angles_h
#define _ROS_delta_manipulator_servo_angles_h
...
namespace delta_manipulator
{
  ...
  class servo_angles : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "delta_manipulator/servo_angles"; };
