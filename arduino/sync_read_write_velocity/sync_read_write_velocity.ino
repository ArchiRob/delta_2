...
void setup() {
  ...
  sw_data[0].goal_velocity = 100;
  sw_data[1].goal_velocity = 100;
  sw_data[2].goal_velocity = 100;
  sw_data[3].goal_velocity = 100;
  sw_data[4].goal_velocity = 100;
  sw_data[5].goal_velocity = 100;
...
void loop() {
  ...
  for(i = 0; i < DXL_ID_CNT; i++){
    ...
    if(sw_data[i].goal_velocity >= 250){
